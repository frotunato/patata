...
if [ ! -f /home/proof ]; then
	sudo debconf-set-selections <<< "postfix postfix/mailname string salchipapa.llameante1@gmail.com"
	...
	sudo bash -c 'echo "AuthUser=salchipapa.llameante1@gmail.com" >> /etc/ssmtp/ssmtp.conf'
